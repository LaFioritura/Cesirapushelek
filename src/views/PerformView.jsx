...
export default function PerformView({
  ...
  void synthPreset;
  void drumPreset;
  void performancePreset;
  void applyBassPreset;
  void applySynthPreset;
    ...
    >
          ...
          return (
            <button
              ...
              style={{
                padding: '6px 6px',
                borderRadius: 4,
                border: `1px solid ${isActive ? scl : `${scl}33`}`,
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.96)', letterSpacing: '0.08em' }}>
            {genre} · {modeName} · arp:{arpeMode}
          </span>
          ...
          <button
            ...
            disabled={page === 0}
            style={{ ...navBtn, opacity: page === 0 ? 0.3 : 1, padding: '1px 5px', fontSize: 10 }}
          >
            ‹
          </button>

          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.96)', fontFamily: 'Space Mono,monospace' }}>
            {page + 1}/4
          </span>
          ...
          <button
            ...
            disabled={page === 3}
            style={{ ...navBtn, opacity: page === 3 ? 0.3 : 1, padding: '1px 5px', fontSize: 10 }}
          >
            ›
          </button>
        </div>
            ...
            >
                ...
                >
                  <div
                    style={{
                      ...
                      boxShadow: `0 0 4px ${lc}`,
                    }}
                  />
                </div>

                {(lane === 'bass' || lane === 'synth') && (
                  <span style={{ fontSize: 9.5, color: 'rgba(255,255,255,0.96)', letterSpacing: '0.04em' }}>
                    {activeNotes[lane]}
                  </span>
                )}
              </div>
              ...
              >
                {visIdx.map((idx) => {
                  ...
                  const on = sd.on;
                  const isActive = step === idx && isPlaying;
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        borderTop: `1px solid ${
                          isActive ? lc : isBar ? `${lc}44` : isBeat ? 'rgba(255,255,255,0.07)' : 'rgba(255,255,255,0.03)'
                        }`,
                        ...
                        background: isActive
                          ...
                          : isTied
                            ? `${lc}1a`
                            : on
                              ? `${lc}${Math.round(Math.min(1, Math.max(0.3, sd.p || 1)) * 255)
                                  .toString(16)
                                  .padStart(2, '0')}`
        ...
        <div style={{ display: 'flex', gap: 1.5, flexShrink: 0, height: 12 }}>
          {visIdx.map((idx) => {
            const bn = bassLine[idx];
            const sn = synthLine[idx];
            ...
            return (
              <div key={idx} style={{ flex: 1, textAlign: 'center' }}>
                {(hasBass || hasSynth) && (
                  <span style={{ fontSize: 6, color: 'rgba(255,255,255,0.96)', fontFamily: 'Space Mono,monospace' }}>
        ...
        {[
          ...
          <div key={label} style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            <input
              ...
              style={{ width: '100%', color: c, accentColor: c, height: 12 }}
            />
          </div>
        ))}
            ...
            <div key={i} style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              <button
                ...
                style={{
                  padding: '4px 2px',
                  borderRadius: 2,
                  border: `1px solid ${scene ? `${gc}44` : 'rgba(255,255,255,0.07)'}`,
                  background: scene ? `${gc}0e` : 'rgba(255,255,255,0.015)',
                  color: scene ? gc : 'rgba(255,255,255,0.94)',
                  fontSize: 10,
                  fontWeight: 700,
                  cursor: 'pointer',
                  fontFamily: 'Space Mono,monospace',
